...
namespace BlazorApp.Models
{
    ...
    public partial class StudentContextProcedures : IStudentContextProcedures
    {
        ...
        public virtual async Task<List<StudentViewByIdResult>> StudentViewByIdAsync(int? StudentId, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
